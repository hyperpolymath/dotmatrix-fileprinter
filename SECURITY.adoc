...
[arabic]
. Navigate to
https://github.com/hyperpolymath/dotmatrix-fileprinter/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/dotmatrix-fileprinter+`) and all its
code
...
https://github.com/hyperpolymath/dotmatrix-fileprinter/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/dotmatrix-fileprinter/discussions[GitHub
Discussions]
...
_Thank you for helping keep Dotmatrix Fileprinter and its users safe._
🛡️
