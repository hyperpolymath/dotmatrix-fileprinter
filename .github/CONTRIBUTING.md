...
toolbox create dotmatrix-fileprinter-dev toolbox enter
dotmatrix-fileprinter-dev \# Install dependencies manually
...
dotmatrix-fileprinter/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/
...
Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/dotmatrix-fileprinter/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/dotmatrix-fileprinter/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/dotmatrix-fileprinter/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/dotmatrix-fileprinter/labels/perimeter-3) — Community sandbox scope
