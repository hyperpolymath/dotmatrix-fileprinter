{
  description = "dotmatrix-fileprinter - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 dotmatrix-fileprinter development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P dotmatrix-fileprinter.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/dotmatrix-fileprinter $out/bin/  # Rust
            # cp bin/dotmatrix-fileprinter $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/dotmatrix-fileprinter";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-dotmatrix-fileprinter" {
