...
Replace all {{PLACEHOLDER}} values with your information:
  Dotmatrix Fileprinter     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  dotmatrix-fileprinter             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/dotmatrix-fileprinter/security/advisories/new)
...
- This repository (`hyperpolymath/dotmatrix-fileprinter`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/dotmatrix-fileprinter/security/advisories)
...
When using Dotmatrix Fileprinter, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/dotmatrix-fileprinter/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/dotmatrix-fileprinter/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/dotmatrix-fileprinter/discussions) |
...
*Thank you for helping keep Dotmatrix Fileprinter and its users safe.* 🛡️
