= Dotmatrix Fileprinter — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/dotmatrix-fileprinter
...
* https://github.com/hyperpolymath/dotmatrix-fileprinter/issues — report bugs
